...
[core]
s0_active_plugins = core;composite;opengl;place;put;resize;wall;compiztoolbox;grid;imgpng;move;scale;expo;unityshell;
...
s0_put_next_output_key = <Super>Left
s0_put_next_output_button = Disabled
s0_put_previous_output_key = <Super>Right
